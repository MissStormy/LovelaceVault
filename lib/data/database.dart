...
class DBHelper {
  ...
  _dbInitialize() async {
    ...
    var database = await openDatabase(path, version: 1,
      ...
      await db.execute(
          "INSERT INTO resources(id, title, author, type, bytes, summary, imagePath, location) VALUES(3, '1984', 'George Orwell', 'Libro', 1234, 'Novela distópica que presenta un futuro totalitario en el que el gobierno controla todos los aspectos de la vida de los ciudadanos.', '', 'Amazon')");
      ...
      await db.execute(
          "INSERT INTO resources(id, title, author, type, bytes, summary, imagePath, location) VALUES(6, 'El Principito', 'Antoine de Saint-Exupéry', 'Libro', 1357, 'Clásico de la literatura infantil que narra las aventuras de un joven príncipe en diferentes planetas, explorando temas como la amistad y la humanidad.', '', 'Casa del Libro')");
      ...
      await db.execute(
          "INSERT INTO resources(id, title, author, type, bytes, summary, imagePath, location) VALUES(8, 'El arte de la guerra', 'Sun Tzu', 'Libro', 2010, 'Tratado militar clásico que aborda estrategias y tácticas militares, aplicables también en el ámbito empresarial y de liderazgo.', '', 'Librería local')");

      await db.execute(
          "INSERT INTO resources(id, title, author, type, bytes, summary, imagePath, location) VALUES(9, 'Inteligencia emocional', 'Daniel Goleman', 'Libro', 1850, 'Exploración sobre la importancia de la inteligencia emocional en el éxito personal y profesional, con estrategias para su desarrollo.', '', 'Biblioteca pública')");
      ...
      await db.execute(
          "INSERT INTO resources(id, title, author, type, bytes, summary, imagePath, location) VALUES(11, 'Cómo ganar amigos e influir sobre las personas', 'Dale Carnegie', 'Libro', 2756, 'Guía clásica sobre habilidades sociales y técnicas de persuasión, con principios prácticos para mejorar las relaciones interpersonales y la comunicación.', '', 'Librería online')");

      await db.execute(
          "INSERT INTO resources(id, title, author, type, bytes, summary, imagePath, location) VALUES(12, 'La teoría de la relatividad', 'Albert Einstein', 'Libro', 1875, 'Explicación accesible de la teoría de la relatividad de Einstein, que transformó nuestra comprensión del tiempo, el espacio y la gravedad.', '', 'Universidad')");
